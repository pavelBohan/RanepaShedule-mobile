...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| **[Ваше имя]** | • Разработка UI/UX на Flutter`<br>`• Интеграция с Telegram (Pentaract Gateway)`<br>`• Дизайн C++ архитектуры`<br>`• Тестирование через Expo | •`mobile/lib/ui/<br>`• `backend/telegram_gateway/<br>`• `backend/api_router.cpp<br>`• `mobile/test/`                 |
